<template>
    <div>
        ...
        <reco-icon v-if="pageInfo.frontmatter.upDate" icon="fa-history">
            <span>{{ pageInfo.frontmatter.upDate }}</span>
        </reco-icon>
...
/deep/ .iconfont, .fa {
	...
	color: #999;
	span{display: inline-block; margin-left 6px; font-weight: normal}
}
</style>
